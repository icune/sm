...
use Statistics\Calculator\Concrete\AveragePostLength;
use Statistics\Calculator\Concrete\MaxPostLength;
use Statistics\Calculator\Concrete\AveragePostNumberPerUser;
use Statistics\Calculator\Concrete\TotalPostsPerWeek;
...
class StatisticsCalculatorFactory
{
    ...
    private const CALCULATOR_CLASS_MAP = [
        ...
        StatsEnum::AVERAGE_POST_NUMBER_PER_USER => AveragePostNumberPerUser::class,
    ];
